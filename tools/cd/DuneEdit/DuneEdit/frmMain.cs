...
namespace DuneEdit
{
	...
	public class frmMain : Form
	{
		...
		[AccessedThroughProperty("txtCoordinates")]
		private TextBox _txtCoordinates;
		...
		internal virtual TextBox txtCoordinates
		{
			[DebuggerNonUserCode]
			get => _txtCoordinates;
			[MethodImpl(MethodImplOptions.Synchronized)]
			[DebuggerNonUserCode]
			set => _txtCoordinates = value;
		}
		...
		private void InitializeComponent()
		{
			...
			tabSietches.Controls.Add(txtCoordinates);
			...
			point2 = (txtCoordinates.Location = new Point(569, 80));
			...
			size2 = (txtCoordinates.Size = new System.Drawing.Size(100, 20));
			txtSubRegionDesc.TabIndex = 59;
			txtCoordinates.TabIndex = 99;
		...
		private void lsSietches_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (lsSietches.SelectedIndex > -1)
			{
				...
				if (source.Count() > 0)
				{
					...
					txtCoordinates.Text = sietch_Item2.Coordinates;
					sietch_Item2 = null;
				}
				PopulateStatuses();
			}

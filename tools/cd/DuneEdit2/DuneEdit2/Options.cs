namespace DuneEdit2
{
    ...
    internal class Options
    {
        ...
        [Option('w', "Write", Default = false, Required = false, HelpText = "[Not implemented yet!] Write hex at position to the save game and exit. Format: ByteHexValue,UncompressedSaveGameHexOffset")]
        public string Write { get; set; } = "";

        [Option('c', "Compress", Default = false, Required = false, HelpText = "Compress the specified file")]
